...
//Postcondition: myStudentRecord.quiz1, myStudentRecord.quiz2, myStudentRecord.midTerm, and 
//myStudentRecord.finalExam have all been initialized to values from the keyboard.
